...
//		}
	...
	public CommandLineRunner demo(UserRepository repository) {
		return(args)->{
			...
			repository.save(new User("pass1","Santhosh","Chennai",0));
			repository.save(new User("pass2","Aamir","Chennai",0));
			repository.save(new User("pass3","Shri","Chennai",0));
			repository.save(new User("pass4","Pavan","Chennai",0));
			repository.save(new User("pass5","Arun","Chennai",0));
